...
\begin{figure}[h!]
\centering
  \includegraphics[width=0.9\textwidth]{fig-aws}
  \caption{CloudFormation Outputs след успешен деплой}
\end{figure}
...
\begin{figure}[h!]
\centering
  \includegraphics[width=0.9\textwidth]{fig-app}
  \caption{Приложението xml2emmet — трансформация на HTML към Emmet нотация}
\end{figure}
