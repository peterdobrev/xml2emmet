...
\noindent Проектът \textbf{xml2emmet} е уеб приложение за трансформация на \textbf{XML} към \textbf{Emmet} нотация, разработен съвместно с Петър Добрев в курса по Уеб технологии. За AWS разширението е добавена функционалност за export на история в Amazon S3, а приложението е хоствано на Amazon EC2 с база данни в Amazon RDS.
